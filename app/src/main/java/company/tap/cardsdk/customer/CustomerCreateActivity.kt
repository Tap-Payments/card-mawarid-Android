...
import company.tap.cardsdk.Validator


import java.util.*

open class CustomerCreateActivity : AppCompatActivity() {
    private var custid: AppCompatEditText? = null
    ...
    private var customerid_l: TextInputLayout? = null
    ...
    private fun bindViews() {
        custid = findViewById(R.id.customer_id)
        ...
        customerid_l = findViewById(R.id.customerid_il)
    ...
    private fun populateCustomerFields(customer: CustomerViewModel?) {
        custid?.setText(customer?.getRef())
