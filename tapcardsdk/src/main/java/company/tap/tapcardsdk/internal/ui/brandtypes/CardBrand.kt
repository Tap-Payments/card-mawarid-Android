package company.tap.tapcardsdk.internal.ui.brandtypes

import androidx.annotation.DrawableRes
import company.tap.tapcardsdk.R
import company.tap.tapcardsdk.internal.ui.utils.TapTextUtils
...
enum class CardBrand(
    ...
    AmericanExpress(
        ...
        errorIcon = if (ThemeManager.currentTheme.isNotEmpty() && ThemeManager.currentTheme.contains("dark")) R.drawable.dark_card else R.drawable.card_icon_light,
        cvcLength = setOf(3, 4),
        defaultMaxLength = 15,
